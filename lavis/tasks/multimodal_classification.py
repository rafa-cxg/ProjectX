...
class MultimodalClassificationTask(BaseTask):
    ...
    def after_evaluation(self, val_result, split_name, epoch, **kwargs):
        ...
        '''
        eval the sgg-brenchmark
        '''
        self.report_sgg_metrics(eval_result_file=eval_result_file, split_name=split_name)
    ...
    '''
    @main_process
    def _report_sgg_metrics(self, eval_result_file, split_name):
        results = json.load(open(eval_result_file))
