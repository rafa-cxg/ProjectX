...
from lavis.common.masking_generator import BlockMaskingGenerator
...
class SggpImageTrainProcessor(SggpImageBaseProcessor):
    def __init__(
        ...
        self.block_mask = BlockMaskingGenerator(window_size, num_masking_patches=75, min_num_patches=16)

    def __call__(self, item):
        return self.transform(item), self.block_mask()
...
@registry.register_processor("sggp_image_eval")
